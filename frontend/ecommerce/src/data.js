export default  {
    products: [{
        _id:'1',
        name: 'Headset Gamer JBL - Quantum 100',
    ...
    {
        _id:'2',
        name: 'Teclado Mecânico Gamer T-Dagger Bora',
        category: 'Periféricos',
    ...
    {
        _id:'3',
        name: 'Dell XPS 15 Intel® Core™ i5-10210U (1.6 GHz até 4.2 GHz, cache de 6MB, quad-core, 10ª geração)',
        category: 'PCs e Notebooks',
        description:'Entretenimento de alto nível'+
